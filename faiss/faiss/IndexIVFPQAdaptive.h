 ...
 */
struct IndexIVFPQAdaptive : IndexIVF {
    bool by_residual; ///< Encode residual or plain vector?

    ProductQuantizerAdaptive pq; ///< produces the codes
...
struct IndexIVFPQAdaptiveStats {
...
FAISS_API extern IndexIVFPQAdaptiveStats indexIVFPQ_stats;
