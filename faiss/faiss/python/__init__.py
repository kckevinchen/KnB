...
from build.faiss.python.swigfaiss import IndexHNSWAdaptive
...
handle_Quantizer(ProductQuantizerAdaptive)
...
add_ref_in_constructor(IndexIVFPQAdaptive, 0)
...
add_ref_in_constructor(IndexHNSWAdaptive, 0)
