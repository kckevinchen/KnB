...
#ifndef FAISS_INDEX_PQ_Adaptive_H
#define FAISS_INDEX_PQ_Adaptive_H
...
struct IndexPQAdaptive : IndexFlatCodes {
    /// The product quantizer used to encode the vectors
    ProductQuantizerAdaptive pq;
     ...
     */
    IndexPQAdaptive(int d,        ///< dimensionality of the input vectors
    ...
    void train_with_prob(idx_t n, const float* x,const double* prob, const double c = 1);

    void set_prob(idx_t n, const double* prob);
 ...
 */
struct MultiIndexQuantizerAdatpive2 : MultiIndexQuantizerAdatpive  {
    /// M Indexes on d / M dimensions
    std::vector<Index*> assign_indexes;
    bool own_fields;

    MultiIndexQuantizerAdatpive2(int d, size_t M, size_t nbits, Index** indexes);

    MultiIndexQuantizerAdatpive2(
            int d,
            size_t nbits,
